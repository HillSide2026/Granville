      ...
      {showSettings ? (
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <Button href="https://themesberg.com/product/dashboard/volt-react" target="_blank" rel="noopener noreferrer" variant="primary" className="mb-3 w-100"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
            <p className="fs-7 text-gray-700 text-center">Available in the following technologies:</p>
            <div className="d-flex justify-content-center">
              <Card.Link href="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard" target="_blank" rel="noopener noreferrer">
              ...
              <Card.Link href="https://themesberg.com/product/dashboard/volt-react" target="_blank" rel="noopener noreferrer">
              ...
              <Card.Link href="https://themesberg.com/product/laravel/volt-admin-dashboard-template" target="_blank" rel="noopener noreferrer">
        ...
        <Row>
          <Col xs={12} lg={6} className="mb-4 mb-lg-0">
            <p className="mb-0 text-center text-xl-left">
              ...
              <Card.Link href="https://themesberg.com" target="_blank" rel="noopener noreferrer" className="text-blue text-decoration-none fw-normal">
                Themesberg
              </Card.Link>
            </p>
          </Col>
          <Col xs={12} lg={6}>
            <ul className="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://themesberg.com/about" target="_blank" rel="noopener noreferrer">
                  About
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://themesberg.com/themes" target="_blank" rel="noopener noreferrer">
                  Themes
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://themesberg.com/blog" target="_blank" rel="noopener noreferrer">
                  Blog
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://themesberg.com/contact" target="_blank" rel="noopener noreferrer">
                  Contact
                </Card.Link>
              </li>
            </ul>
