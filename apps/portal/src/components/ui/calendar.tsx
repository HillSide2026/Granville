    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation }) => {
          if (orientation === 'left') {
            return <Icon name='chevron-left' className={cn('size-4', className)} />
          }
          if (orientation === 'right') {
            return <Icon name='chevron-right' className={cn('size-4', className)} />
          }
          return <Icon name='chevron-down' className={cn('size-4', className)} />
        },
