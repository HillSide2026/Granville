...
**Beachhead: Canada-based agencies and startups paying foreign "payroll"** — recurring
cross-border payouts to overseas contractors and team members. They're stuck reconciling those
payouts, the FX, and the fees into books that never tie out, using a bank + Wise/PayPal + a
spreadsheet. They want that problem *gone* — not to become a fintech. (See
[ICP](../02-customers/icp-and-segments.md).)

**Market to four, sell to one:** publicly Granville addresses four segments — **agencies,
influencers, marketplaces, ecommerce** — but BD focuses the motion on the agency-payroll wedge,
then expands. We do **not** sell to EMIs/MSBs as the buyer — Granville *provides* those regulated
services; the buyer consumes them. (Note: contractor payouts, **not** formal employment payroll
— a scope line we hold firmly.)
...
| Horizon | Business goal | Gated by product |
|---|---|---|
...
- **Beachhead segment:** Canada-based agencies & startups paying foreign contractor "payroll."
- **Geography:** Canada-first (founder jurisdiction → cleanest regulated-services path).
...
- [ ] Exact scope line: how do we serve "foreign payroll" as **contractor payouts** without
      drifting into employment-payroll/tax obligations? (Counsel checkpoint.)
